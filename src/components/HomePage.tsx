      ...
      <section id="industries" className="relative py-14 md:py-20 overflow-hidden bg-white text-[#001C55]">
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-[1400px] relative z-10">
          <div className="w-full md:max-w-[68%] lg:max-w-[62%]">
            ...
            <h2 className={`${type.sectionTitle} text-[#001C55] mb-4 md:mb-5`}>
              POWERING EVERY INDUSTRY
            </h2>
            <Link
              href="/industries"
              className={`inline-flex items-center gap-2 text-[#1a56db] ${type.nav} hover:underline mb-10 md:mb-12 w-fit`}
            >
